...
<%@ Assembly name="DevExpress.Data.v12.1, Version=12.1.7.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" %>
<%@ Register Assembly="DevExpress.Web.ASPxHtmlEditor.v12.1, Version=12.1.7.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxHtmlEditor"
	TagPrefix="dxhe" %>
<%@ Register Assembly="DevExpress.Web.ASPxEditors.v12.1, Version=12.1.7.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxEditors"
	TagPrefix="dxe" %>
<%@ Register Assembly="DevExpress.Web.v12.1, Version=12.1.7.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxPanel"
	TagPrefix="dxp" %>
...
<%@ Register Assembly="DevExpress.Web.ASPxHtmlEditor.v12.1, Version=12.1.7.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxHtmlEditor" TagPrefix="dxhe" %>
														...
														<td class="propGroupContentCell">                                                                                                                
															<table cellpadding="0" cellspacing="0">
																...
																<tr>
																	...
																	<td class="rowsInputCell" style="display: none;" id='<% =HtmlEditor.ClientID + "_dxeWidthSpinEditCell"%>' colspan="2">
																		<table cellpadding="0" cellspacing="0">
																			<tr>
																				<td>                                                                                
																...
																<tr>
																	...
																	<td class="rowsInputCell" style="display: none;" id='<% =HtmlEditor.ClientID + "_dxeHeightSpinEditCell"%>' colspan="2">
																		<table cellpadding="0" cellspacing="0">
																			<tr>
																				<td>                                                                                
...
<script type="text/javascript" id="dxss_InsertTableForm">
	...
	function OnCmdWidthSelectedIndexChanged_InsertTableForm(widthCombox) {
		_aspxSetElementDisplay(_aspxGetElementById('<% =HtmlEditor.ClientID + "_dxeWidthSpinEditCell"%>'), widthCombox.GetValue() == "custom");
	}
	function OnCmdHeightSelectedIndexChanged_InsertTableForm(heightCombox) {
		_aspxSetElementDisplay(_aspxGetElementById('<% =HtmlEditor.ClientID + "_dxeHeightSpinEditCell"%>'), heightCombox.GetValue() == "custom");
	}
</script>
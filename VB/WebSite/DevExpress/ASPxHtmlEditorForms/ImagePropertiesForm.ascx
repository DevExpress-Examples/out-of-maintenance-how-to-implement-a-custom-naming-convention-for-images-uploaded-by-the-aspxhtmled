					...
					<td>
						<table cellpadding="0" cellspacing="0">
							<tr>
								...
								<td>
									<dxe:ASPxSpinEdit ID="spnWidth" ClientInstanceName="_dxeSpnWidth" runat="server" Height="21px" Number="1" Width="52px" AllowNull="True" NumberType="Integer" MaxValue="10000" MinValue="1">
							...
							<tr>
								...
								<td>
									<dxe:ASPxSpinEdit ID="spnHeight" ClientInstanceName="_dxeSpnHeight" runat="server" Height="21px" Number="1" Width="52px" AllowNull="True" MinValue="1" NumberType="Integer" MaxValue="10000">
										<SpinButtons ShowIncrementButtons="False">
										</SpinButtons>
